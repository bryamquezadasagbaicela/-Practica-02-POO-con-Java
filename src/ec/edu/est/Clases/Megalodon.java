 ...
 * metodos de la clase hija megalodon
 *
...
public final class Megalodon extends Acuatico implements Acciones {
    ...
    public Megalodon(String nombre, String tipoReproduccion, String sexo, String termino, int numeroAletas, boolean aguaSalada, int numeroEspinas, boolean venenoso, boolean depredadorSolitario, int numeroIlerasDientes, boolean canibal, boolean extinto) {
