...
/**
 * esta clase instancia los atributos, setters y getters, constructores y
 * metodos de la clase hija TiranosaurioRex
 *
...
public final class TiranosaurioRex extends Terrestre implements Acciones {
    ...
    public TiranosaurioRex(String nombre, String tipoReproduccion, String sexo, String termino, int numeroGarras, int numeroPatas, int numeroDientesCaninos, boolean depredadorSolitario, boolean extinto, boolean alimentoCarroño, boolean capacidadSensorial, boolean canibal) {
